...
--
-- Host: localhost:3306
-- Generation Time: Sep 21, 2022 at 11:31 AM
...
(38, 11, 'demo msg', 'msg sent', 2, NULL, '2022-09-16 08:57:23', '2022-09-16 08:57:23');
...
(2, 'anju', 'rb', 'anju@gmail.com', 'female', 13, 1234534212, 'a753d9fa7294440c6d7a00d873d0c4b2'),
(3, 'ammu', 's', 'ammu@gmail.com', 'female', 10, 1234534212, '6c44e5cd17f0019c64b042e4a745412a'),
...
(6, 'sanju', 's', 'sanju@gmail.com', 'male', 13, 1234534212, '7d59f6068ca1ae414b17bdb258542b25'),
...
--
ALTER TABLE `comments`
  MODIFY `comment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`complaint_id`) REFERENCES `complaint` (`complaint_id`) ON DELETE CASCADE ON UPDATE CASCADE,
