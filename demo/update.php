          ...
          <div class="card-body p-5 text-center">
            ...
            <form role="form" method="post" action="" id="resetforms">
              ...
              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control" name="email" id=""/>
                <label class="form-label" for="typeEmailX">Email</label>
              </div>
              <input class="btn btn-outline-dark btn-lg px-5 my-3" type="submit" value="Reset" name="submit" id="show">
              </div>
              <div id="pass">
              <div class="form-outline form-white mb-4">
              ...
              <input class="btn btn-outline-light btn-lg px-5 my-3" type="submit" value="Reset" name="reset" id="">
              </div>
     </form>
          </div>
        </div>
