...
<head>
	...
	<script src="assetss/js/log.js"></script>
</head>
<body>
	...
	<div class="navbar navbar-fixed-top ">
		<div class="navbar-inner">
			<div class="container">
				...
				<i class="fa fa-user"></i><a class="brand" href="../index.html">
			  		Admin
			  	</a>
		...
		<div class="container">
			<div class="row">
				<div class="module module-login span4 offset4">
					<form class="form-vertical" method="post" id="loginforms">
